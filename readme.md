...
功能上的更新我目前还没有更新，我的打算是更新如下内容：
1. 增加特定的词响应相关的功能，比如语音输入删除的时候，应该按下删除键；空格、冒号等等也是一样。除此之外，还应该允许自定义添加热词，并自定义的增加一些常用的系统操作的功能模块。比如说打开某某应用，比如当我说打开飞书的时候，应该直接帮我打开飞书。就相当于把它改成一个语音的 agent 吧。